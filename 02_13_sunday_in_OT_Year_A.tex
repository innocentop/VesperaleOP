...
\section{Second Vespers}
 ...
 \subsection{Hymnus}  \greannotation{VIII} \index[Hymnus]{Lucis creator} \label{Lucis creator (Hymnus)} \grecommentary[10pt]{\emph{Lucis creator optime}} \gresetinitiallines{1} \gresetlyriccentering{syllable} \grechangedim{spaceabovelines}{0.5cm}{scalable}  \gregorioscore{chants/hy--lucis-creator-english}
 ...
 \subsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Qui perdiderit} \label{Qui perdiderit (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 10:39 [AR]} \grechangestyle{initial}{\fontsize{1}{1}\selectfont} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--qui_perdiderit--solesmes-op} \vspace{5pt} \emph{He who loses his life for my sake will find it forever.}   
   ...
   \subsection{Canticum Evangelicum} \subsubsection{The soul rejoices in the Lord} \greannotation{I g}  \grecommentary[3pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/magnificat1g} \input{chants/magnificat-translation}
 ...
 \newpage
  ...
  \subsection{Oratio conclusiva}   \index[Oratio conclusiva]{13th Sunday in OT} \label{25th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.13}
