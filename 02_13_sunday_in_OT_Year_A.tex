...
\section{Second Vespers}
 ...
 \subsection{Hymnus}  \greannotation{VIII} \index[Hymnus]{Lucis creator} \label{Lucis creator (Hymnus)} \grecommentary[0pt]{} \gresetinitiallines{1} \gresetlyriccentering{syllable} \grechangedim{spaceabovelines}{0.5cm}{scalable}  \gregorioscore{chants/hy--lucis-creator-english}
