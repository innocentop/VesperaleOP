...
\section{Second Vespers}
 ...
 \subsection{Canticum Evangelicum} \subsubsection{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}}  \grecommentary[3pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/magnificat8G} \input{chants/magnificat-translation}
 ...
 \subsection{Preces}   \index[Preces]{Week I, Sunday, Second Vespers} \label{Week I, Sunday, Second Vespers (Preces)}    \input{intercessions/intercessions-ot-sunday-week-1-2nd-vespers}
  ...
  \subsection{Oratio conclusiva}   \index[Oratio conclusiva]{25th Sunday in OT} \label{25th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.05}
