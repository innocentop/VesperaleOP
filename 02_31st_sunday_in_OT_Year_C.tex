...
%%Combination
\chapter{31\textsuperscript{st} Sunday of Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsection{Oratio conclusiva}   \index[Oratio conclusiva]{31st Sunday in OT} \label{31st Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.31}
