...
%%Combination
\chapter{28\textsuperscript{th} Sunday of Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsection{Antiphona}  \greannotation{IV E} \index[Antiphona]{Psalm 111} \label{Psalm 111 (Antiphona)} \grecommentary[0pt]{Ps 111:1} \gresetinitiallines{1} \gresetlyriccentering{vowel} \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \gregorioscore{chants/ab--in_mandatis--dominican}  \grechangedim{maxbaroffsettextleft}{0.6 cm}{scalable}
