...
\chapter{3\textsuperscript{rd} Sunday in Ordinary Time (Year A)}
\section{Second Vespers}
 ...
 \subsection{Antiphona}  \greannotation{IV E} \index[Antiphona]{Fidelia omnia} \label{Fidelia omnia (Antiphona)} \grecommentary[0pt]{Ps 110:8} \gresetinitiallines{1} \gresetlyriccentering{vowel} \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \gregorioscore{chants/an--fidelia_omnia--dominican}  \grechangedim{maxbaroffsettextleft}{0.6 cm}{scalable}
 ...
 \subsection{Canticum} \subsubsection{The wedding of the Lamb} \greannotation{VI} \index[Canticum]{Salus et gloria} \label{Salus et gloria (Canticum)} \grecommentary[0pt]{Cf. Ap 19:1-2, 5-7 [AR]} \gresetinitiallines{1} \gresetlyriccentering{syllable}  \gregorioscore{chants/canticle--salus-et-honor--dom-1-et-3--english}
 \subsection{Lectio brevis}     \hfill 1 Pt 1:3-5    \input{readings/lectio_brevis_1.Pt.1.3-5.tex}
 ...
 \subsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Ambulans Iesus} \label{Ambulans Iesus (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 4:18, 19, 20} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--ambulans_iesus--dominican--id_5782} \vspace{5pt} \emph{}
 \subsection{Canticum Evangelicum} \subsubsection{The soul rejoices in the Lord}\greannotation{I \textsc{d}} \label{Magnificat 8G (Canticum Evangelicum)} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1D} \input{chants/magnificat-translation}


 \subsection{Preces}   \index[Preces]{Week III, Sunday, Second Vespers} \label{Week III, Sunday, Second Vespers (Preces)}     \input{intercessions/intercessions-ot-sunday-week-3-2nd-vespers}
 ...
 \subsection{Oratio conclusiva} \input{prayers/or-ordinary-time.03}
