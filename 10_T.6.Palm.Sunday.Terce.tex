...
\subsection{Invocation}  \greannotation{} \index[Invocation]{O God come to my assistance} \label{O God come to my assistance (Invocation)} \grecommentary[0pt]{} \gresetinitiallines{1} \gresetlyriccentering{syllable} \grechangedim{spaceabovelines}{0.25 cm}{scalable} \gregorioscore{chants/misc.o_god_come--lent} \grechangedim{spaceabovelines}{0 cm}{scalable}   \newpage
...
\subsection{Hymn}  \greannotation{I} \index[Hymn]{Nunc sancte nobis} \label{Nunc sancte nobis (Hymn)} \grecommentary[3pt]{} \gresetinitiallines{1} \gresetlyriccentering{syllable} \grechangedim{spaceabovelines}{0.25 cm}{scalable} \gregorioscore{chants/hy--nunc_sancte_nobis--english--passiontide} \grechangedim{spaceabovelines}{0 cm}{scalable}   \newpage
\subsection{Antiphona}  \greannotation{I g} \index[Antiphona]{Pueri Hebraeorum tollentes} \label{Pueri Hebraeorum tollentes (Antiphona)} \grecommentary[3pt]{} \gresetinitiallines{1}  \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \gregorioscore{chants/an--pueri_hebraeorum_vestimenta--dominican--id_6173--psalm-tone}  \grechangedim{maxbaroffsettextleft}{0.6 cm}{scalable} \vspace{5pt} \emph{The Hebrew children spread their garments in the way, and cried out, saying: ``Hosanna to the son of David; Blessed is He who comes in the name of the Lord."} \newpage
\subsection{Versicle}  \greannotation{} \index[Versicle]{Create in me a clean heart} \label{Create in me a clean heart (Versicle)} \grecommentary[0pt]{} \gresetinitiallines{0} \gresetlyriccentering{syllable} \grechangedim{spaceabovelines}{0.25 cm}{scalable} \gregorioscore{chants/versicle--create_in_me_a_clean_heart} \grechangedim{spaceabovelines}{0 cm}{scalable}   \newpage
