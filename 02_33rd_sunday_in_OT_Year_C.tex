...
%%Combination
\chapter{33\textsuperscript{rd} Sunday of Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsection{Oratio conclusiva}   \index[Oratio conclusiva]{33rd Sunday in OT} \label{33rd Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.33}
