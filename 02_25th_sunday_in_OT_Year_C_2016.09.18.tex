...
\subsection{September 18, 2016}
 ...
 \subsection{Psalm 113A} \subsubsection{The Israelites are delivered from the bondage of Egypt}  \index[Psalmus]{Psalm 113A} \label{Psalm 113A (Psalmus)} \emph{You too left Egypt when, at baptism, you renounced that world which is at enmity with God (Saint Augustine).}   \vspace{5pt} \par \input{psalms/psalm113Aenglish3-3}
 ...
 \subsection{Lectio brevis}     \hfill \emph{2 Cor 1:3-4}   \input{readings/lectio_brevis_2.Cor.1.3-4.tex}
 ...
 \subsection{Preces}   \index[Preces]{Week I, Sunday, Second Vespers} \label{Week I, Sunday, Second Vespers (Preces)}    \input{intercessions/intercessions-ot-sunday-week-1-2nd-vespers}
