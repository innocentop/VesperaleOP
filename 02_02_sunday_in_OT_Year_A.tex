...
%%This is the version for Week II and IV
 \subsection{Canticum} \subsubsection{The wedding of the Lamb} \greannotation{} \index[Canticum]{Salus et gloria} \label{Salus et gloria (Canticum)} \grecommentary[5pt]{Cf. Ap 19:1-2, 5-7} \gresetinitiallines{1} \gresetlyriccentering{syllable}  \gregorioscore{chants/canticle--salus-et-honor--d--english}
 \subsection{Lectio brevis}     \hfill 2 Th 2:13-14    \input{readings/lectio_brevis_2.Th.2.13-14.tex}
 ...
 \subsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Magnus Dominus noster} \label{Magnus Dominus noster (Responsorium brevis)} \grecommentary[0pt]{Ps 146:5} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/rb--magnus_dominus_noster--solesmes}
  ...
  \subsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Hoc est testimonium} \label{Hoc est testimonium (Antiphona ad Magnificat)} \grecommentary[0pt]{Io 1:32, 15} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--hoc_est_testimonium--solesmes} \vspace{5pt} \emph{This is the testimony that John bore: ``The one who comes after me was before me."}

 \subsection{Canticum Evangelicum} \subsubsection{The soul rejoices in the Lord} \greannotation{I g} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1g} \input{chants/magnificat-translation}


 \subsection{Preces}   \index[Preces]{Week II, Sunday, Second Vespers} \label{Week II, Sunday, Second Vespers (Preces)}     \input{intercessions/intercessions-ot-sunday-week-2-2nd-vespers}
 ...
 \subsection{Oratio conclusiva}       \input{prayers/or-ordinary-time.02}
