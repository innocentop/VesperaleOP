...
\section{Second Vespers}
 ...
 \subsection{Antiphona}  \greannotation{T. per.} \index[Antiphona]{Ex Ægypto} \label{Ex Ægypto (Antiphona)} \grecommentary[0pt]{Cf. Ex 13:14} \gresetinitiallines{1} \gresetlyriccentering{vowel} \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \gregorioscore{chants/an--regnum_tuum--solesmes}  \grechangedim{maxbaroffsettextleft}{0.6 cm}{scalable}
