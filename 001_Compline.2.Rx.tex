...
\subsection{After Second Vespers and until Epiphany}
 \subsubsection{Antiphona ad Nunc dimittis} \paragraph{} \greannotation{V} \index[Antiphona ad Nunc dimittis]{Alleluia Verbum caro} \label{Alleluia Verbum caro (Antiphona ad Nunc dimittis)} \grecommentary[3pt]{Io 1:15} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--alleluia_verbum--dominican}
