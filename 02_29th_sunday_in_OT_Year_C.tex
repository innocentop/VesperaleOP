...
%%Combination
\chapter{29\textsuperscript{th} Sunday of Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsection{Antiphona}  \greannotation{T. per.} \index[Antiphona]{Ex Ægypto} \label{Ex Ægypto (Antiphona)} \grecommentary[0pt]{Cf. Ex 13:14} \gresetinitiallines{1} \gresetlyriccentering{vowel} \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \gregorioscore{chants/an--ex_aegypto_--solesmes--tonus-peregrinus}  \grechangedim{maxbaroffsettextleft}{0.6 cm}{scalable}
 ...
 \subsection{Oratio conclusiva}   \index[Oratio conclusiva]{29th Sunday in OT} \label{29th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.29}
